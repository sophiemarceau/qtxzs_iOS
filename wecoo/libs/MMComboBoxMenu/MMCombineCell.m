...
- (void)setItem:(MMItem *)item {
    ...
    for (int i = 0; i < item.childrenNodes.count; i ++) {
        ...
        button.frame = CGRectMake(orginX, orginy-8*AUTO_SIZE_SCALE_X, ItemWidth, ItemHeight);
        button.titleLabel.font = [UIFont systemFontOfSize:12*AUTO_SIZE_SCALE_X];
        ...
        [button setTitleColor:subItem.isSelected?[UIColor whiteColor]: FontUIColorBlack forState:UIControlStateNormal];
