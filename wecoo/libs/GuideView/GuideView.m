...
//    _btnMaskView.frame = btnMaskRect;
    _btnMaskView.frame = CGRectMake((kScreenWidth-((550/2)*AUTO_SIZE_SCALE_X+3)), kScreenHeight-(63), (550/2)*AUTO_SIZE_SCALE_X+3, 63);
...
//    _tipsLabel.bottom = _arrwoView.top + 10;
    ...
    _okBtn.bottom = _btnMaskView.top - 24*AUTO_SIZE_SCALE_X;
}
...
- (UIButton *)okBtn {
    if (!_okBtn) {
        ...
        [btn setImage:[UIImage imageNamed:@"cover-report"] forState:UIControlStateNormal];
        [btn sizeToFit];
...
- (UIImageView *)btnMaskView {
    if (!_btnMaskView) {
        UIImage *image = [UIImage imageNamed:@"cover-report-btnWhite"];
//        image = [image maskImage:[[UIColor blackColor] colorWithAlphaComponent:0.75]];
        UIImageView *imageView = [[UIImageView alloc] initWithImage:image];
//        UIImageView *imageView = [UIImageView new];
//        imageView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.75];
//        imageView.backgroundColor  = [[UIColor blueColor] colorWithAlphaComponent:0.75];
