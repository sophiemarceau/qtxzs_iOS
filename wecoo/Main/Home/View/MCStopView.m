...
//        lineView1.frame = CGRectMake(0, _headerView_Height-1, kScreenWidth, 0.5);
//        lineView1.backgroundColor = lineImageColor;
...
-(void)prepareSegmentView{
    ...
    _SegmentView.titleTextAttributes = @{NSForegroundColorAttributeName : FontUIColorGray, NSFontAttributeName : [UIFont systemFontOfSize:15*AUTO_SIZE_SCALE_X]};
    _SegmentView.selectedTitleTextAttributes = @{NSForegroundColorAttributeName : RedUIColorC1,NSFontAttributeName : [UIFont systemFontOfSize:15*AUTO_SIZE_SCALE_X]};

    _SegmentView.selectionIndicatorHeight = 2*AUTO_SIZE_SCALE_X;
    _SegmentView.selectionIndicatorColor = RedUIColorC1;
...
//        }
    ...
    lineView2.frame = CGRectMake(0, _SegmentView.frame.size.height, kScreenWidth, 0.5);
    lineView2.backgroundColor = lineImageColor;
    [_SegmentView addSubview:lineView2];
...
//    if (offsetY >0) {
//        CGFloat alpha = MIN(1, offsetY/(_headerView_Height));
//        
//        [_selfCtl.navigationController.navigationBar cnSetBackgroundColor:[color colorWithAlphaComponent:alpha]];
//        
//        //_descriptionView.alpha = 1 - alpha;
