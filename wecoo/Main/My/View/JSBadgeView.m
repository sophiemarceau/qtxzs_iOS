...
#define kDefaultBadgeTextFont [UIFont systemFontOfSize:9*AUTO_SIZE_SCALE_X]

#define kDefaultBadgeShadowColor [UIColor clearColor]

#define kBadgeStrokeColor [UIColor whiteColor]
#define kBadgeStrokeWidth 0.5f
...
//    self.badgeTextFont = [UIFont systemFontOfSize:17/2*AUTO_SIZE_SCALE_X];
}
