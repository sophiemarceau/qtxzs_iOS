...
@interface ReviewPassViewController ()<UIGestureRecognizerDelegate>{
    Boolean isReturnProgressPage;
}
...
- (UILabel *)submitLabel {
    if (_submitLabel == nil) {
        self.submitLabel = [CommentMethod initLabelWithText:@"操作成功" textAlignment:NSTextAlignmentCenter font:18*AUTO_SIZE_SCALE_X];
