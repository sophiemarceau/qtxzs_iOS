//
//  PlatformfeedbackViewController.m
//  wecoo
//
...
@interface PlatformfeedbackViewController ()<UITableViewDelegate,UITableViewDataSource>{
noWifiView *failView;
...
@implementation PlatformfeedbackViewController
...
-(void)initData{
    ...
    NSDictionary *dic = @{
                          @"report_id":self.search_id,
                          };
    
    [[RequestManager shareRequestManager] SearchPlatformFeedbackCrlDtoListResult:dic viewController:self successData:^(NSDictionary *result){
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [MobClick beginLogPageView:kPlatformTimelinePage];//("PageOne"为页面名称，可自定义)
}
- (void)viewWillDisappear:(BOOL)animated
{
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:kPlatformTimelinePage];
}
