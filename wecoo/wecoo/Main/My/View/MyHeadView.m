...
#pragma mark - 添加约束
    ...
    [self.balanceLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self);
        make.top.equalTo(self.balanceContent.mas_bottom).offset(13*AUTO_SIZE_SCALE_X);
    ...
    [self.efficiencyLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self);
        make.top.equalTo(self.efficiencyContent.mas_bottom).offset(13*AUTO_SIZE_SCALE_X);
        make.size.mas_equalTo(CGSizeMake(kScreenWidth/2, 20*AUTO_SIZE_SCALE_X));
    }];
...
- (UIImageView *)headerImageView {
    if (_headerImageView == nil) {
        ...
        self.headerImageView.layer.cornerRadius = 30.0;
...
- (UILabel *)NameLabel {
    if (_NameLabel == nil) {
        self.NameLabel = [CommentMethod initLabelWithText:@"屈小波" textAlignment:NSTextAlignmentLeft font:14*AUTO_SIZE_SCALE_X];
...
- (UILabel *)PhoneLabel {
    if (_PhoneLabel == nil) {
        self.PhoneLabel = [CommentMethod initLabelWithText:@"13681588610" textAlignment:NSTextAlignmentLeft font:14*AUTO_SIZE_SCALE_X];
...
- (UILabel *)balanceContent {
    if (_balanceContent == nil) {
        self.balanceContent = [CommentMethod initLabelWithText:@"67400.00" textAlignment:NSTextAlignmentCenter font:14*AUTO_SIZE_SCALE_X];
...
- (UILabel *)balanceLabel {
    if (_balanceLabel == nil) {
        self.balanceLabel = [CommentMethod initLabelWithText:@"账户余额" textAlignment:NSTextAlignmentCenter font:12*AUTO_SIZE_SCALE_X];
...
- (UILabel *)efficiencyContent {
    if (_efficiencyContent == nil) {
        self.efficiencyContent = [CommentMethod initLabelWithText:@"90%" textAlignment:NSTextAlignmentCenter font:14*AUTO_SIZE_SCALE_X];
...
- (UILabel *)efficiencyLabel {
    if (_efficiencyLabel == nil) {
        self.efficiencyLabel = [CommentMethod initLabelWithText:@"报备有效率" textAlignment:NSTextAlignmentCenter font:12*AUTO_SIZE_SCALE_X];
