...
-(void)showLoadingWithText:(NSString *)text Type:(showHUDType)type Enabled:(BOOL)enabled Bounds:(CGRect)bounds Center:(CGPoint)center BackgroundAlpha:(CGFloat)backgroundAlpha ComeTime:(CGFloat)comeTime StayTime:(CGFloat)stayTime GoTime:(CGFloat)goTime{
    ...
    [YzdHUDLabel shareHUDView].textColor = [UIColor whiteColor];
    [[YzdHUDIndicator shareHUDView] stopAnimating];
    [YzdHUDImageView shareHUDView].alpha = 0;
    
//    [YzdHUDBackgroundView shareHUDView].backgroundColor = [UIColor redColor];
//    [YzdHUDBackgroundView shareHUDView].alpha = 1;
//    
//    [YzdHUDImageView shareHUDView].backgroundColor = [UIColor blueColor];
//    [YzdHUDImageView shareHUDView].alpha = 1;
//    
//    [YzdHUDLabel shareHUDView].backgroundColor = [UIColor purpleColor];
//    [YzdHUDLabel shareHUDView].alpha = 1;
//    
//    [YzdHUDIndicator shareHUDView].backgroundColor = [UIColor blackColor];
//    [YzdHUDIndicator shareHUDView].alpha = 1;
...
-(void)goTimeInit{
    [YzdHUDBackgroundView shareHUDView].alpha = 1;
    [YzdHUDBackgroundView shareHUDView].backgroundColor = [UIColor blackColor];
